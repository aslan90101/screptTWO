...
TextLabel.Position = UDim2.new(0, 0, 0.101428568, 0)
TextLabel.Size = UDim2.new(0, 232, 0, 36)
TextLabel.Font = Enum.Font.SourceSansBold
TextLabel.Text = "Ragebot"
...
TextLabel_2.Position = UDim2.new(0, 0, 0.171428576, 0)
TextLabel_2.Size = UDim2.new(0, 232, 0, 32)
TextLabel_2.Font = Enum.Font.SourceSansBold
TextLabel_2.Text = "AntiAim"
...
TextLabel_3.Position = UDim2.new(0, 0, 0.239999995, 0)
TextLabel_3.Size = UDim2.new(0, 231, 0, 30)
TextLabel_3.Font = Enum.Font.SourceSansBold
TextLabel_3.Text = "Legitbot"
...
TextLabel_4.Position = UDim2.new(0.0646551698, 0, 0.311428577, 0)
...
TextLabel_5.Position = UDim2.new(0.0603448264, 0, 0.439999998, 0)
TextLabel_5.Size = UDim2.new(0, 200, 0, 25)
TextLabel_5.Font = Enum.Font.SourceSansBold
TextLabel_5.Text = "Weapon"
...
TextLabel_6.Position = UDim2.new(0.0603448264, 0, 0.53285712, 0)
TextLabel_6.Size = UDim2.new(0, 200, 0, 24)
TextLabel_6.Font = Enum.Font.SourceSansBold
TextLabel_6.Text = "World"
...
TextLabel_7.Position = UDim2.new(0.305220872, 0, 0.40142858, 0)
TextLabel_7.Size = UDim2.new(0, 45, 0, 127)
...
TextLabel_8.Position = UDim2.new(0.514056206, 0, 0.40142858, 0)
TextLabel_8.Size = UDim2.new(0, 45, 0, 127)
...
TextLabel_9.Position = UDim2.new(0.305220872, 0, 0.257142872, 0)
TextLabel_9.Size = UDim2.new(0, 97, 0, 101)
...
TextLabel_10.Position = UDim2.new(0.393574297, 0, 0.176021248, 0)
TextLabel_10.Size = UDim2.new(0, 52, 0, 50)
...
TextLabel_11.Position = UDim2.new(0.152610436, 0, 0.257142901, 0)
TextLabel_11.Size = UDim2.new(0, 38, 0, 101)
...
TextLabel_12.Position = UDim2.new(0.694779098, 0, 0.257142901, 0)
TextLabel_12.Size = UDim2.new(0, 40, 0, 101)
...
TextButton.Position = UDim2.new(-4.16064262, 0, 0.366720527, 0)
...
TextLabel_13.Position = UDim2.new(-4.22088337, 0, 0.967689812, 0)
TextLabel_13.Size = UDim2.new(0, 54, 0, 61)
...
TextLabel_14.Position = UDim2.new(-4.00401592, 0, 0.967689812, 0)
TextLabel_14.Size = UDim2.new(0, 177, 0, 20)
TextLabel_14.Font = Enum.Font.SourceSansBold
TextLabel_14.Text = "SIGMA Player"
...
TextLabel_15.Position = UDim2.new(-4.00401592, 0, 1.01777065, 0)
TextLabel_15.Size = UDim2.new(0, 43, 0, 26)
TextLabel_15.Font = Enum.Font.SourceSansBold
TextLabel_15.Text = "Till"
...
TextLabel_16.Position = UDim2.new(-3.83132505, 0, 1.0226171, 0)
TextLabel_16.Size = UDim2.new(0, 116, 0, 21)
TextLabel_16.Font = Enum.Font.SourceSansBold
TextLabel_16.Text = "☺INFINITY"
...
TextLabel_17.Position = UDim2.new(-4.16465855, 0, 0.484652668, 0)
TextLabel_17.Size = UDim2.new(0, 200, 0, 24)
TextLabel_17.Font = Enum.Font.SourceSansBold
TextLabel_17.Text = "Grenades"
...
TextLabel_19.Position = UDim2.new(-4.1566267, 0, 0.662358642, 0)
TextLabel_19.Size = UDim2.new(0, 200, 0, 25)
TextLabel_19.Font = Enum.Font.Unknown
TextLabel_19.Text = "Miscellanous"
...
TextLabel_20.Position = UDim2.new(-4.1566267, 0, 0.723747969, 0)
TextLabel_20.Size = UDim2.new(0, 197, 0, 24)
TextLabel_20.Font = Enum.Font.SourceSansBold
TextLabel_20.Text = "Main"
...
TextLabel_21.Position = UDim2.new(-4.16064262, 0, 0.781906307, 0)
TextLabel_21.Size = UDim2.new(0, 200, 0, 24)
TextLabel_21.Font = Enum.Font.SourceSansBold
TextLabel_21.Text = "Inventory"
...
TextLabel_22.Position = UDim2.new(-4.1566267, 0, 0.836833596, 0)
TextLabel_22.Size = UDim2.new(0, 200, 0, 24)
TextLabel_22.Font = Enum.Font.SourceSansBold
TextLabel_22.Text = "Scripts"
...
TextLabel_23.Position = UDim2.new(-4.16064262, 0, 0.886914372, 0)
TextLabel_23.Size = UDim2.new(0, 200, 0, 24)
TextLabel_23.Font = Enum.Font.SourceSansBold
TextLabel_23.Text = "Configs"
...
TextLabel_24.Position = UDim2.new(-1.63855422, 0, -0.0339256972, 0)
TextLabel_24.Size = UDim2.new(0, 361, 0, 239)
...
TextLabel_25.Position = UDim2.new(-1.63855422, 0, -0.0306946691, 0)
TextLabel_25.Size = UDim2.new(0, 152, 0, 34)
TextLabel_25.Font = Enum.Font.SourceSansBold
TextLabel_25.Text = "Exploits"
...
TextLabel_26.Position = UDim2.new(-1.11646581, 0, 0.943457186, 0)
TextLabel_26.Size = UDim2.new(0, 200, 0, 50)
TextLabel_26.Font = Enum.Font.SourceSansBold
TextLabel_26.Text = "♦•Global•♦"
...
TextLabel_27.Position = UDim2.new(0.0226986129, 0, 0.0271428563, 0)
TextLabel_27.Size = UDim2.new(0, 357, 0, 239)
...
TextLabel_28.Position = UDim2.new(0.0214375779, 0, 0.0271428563, 0)
TextLabel_28.Size = UDim2.new(0, 69, 0, 36)
TextLabel_28.Font = Enum.Font.SourceSansBold
TextLabel_28.Text = "Main"
...
TextButton_5.Position = UDim2.new(0.0378310196, 0, 0.0900000036, 0)
TextButton_5.Size = UDim2.new(0, 334, 0, 26)
TextButton_5.Font = Enum.Font.SourceSansBold
TextButton_5.Text = "Blizt Crack"
...
TextButton_6.Position = UDim2.new(0.0378310196, 0, 0.145714283, 0)
TextButton_6.Size = UDim2.new(0, 334, 0, 24)
TextButton_6.Font = Enum.Font.SourceSansBold
TextButton_6.Text = "Verbal Hub key: v2update"
...
TextLabel_30.Position = UDim2.new(1.0617907, 0, 0.101428568, 0)
TextLabel_30.Size = UDim2.new(0, 200, 0, 50)
TextLabel_30.Font = Enum.Font.SourceSansBold
TextLabel_30.Text = "Nickname"
...
TextLabel_31.Position = UDim2.new(1.0617907, 0, 0.19571428, 0)
TextLabel_31.Size = UDim2.new(0, -2, 0, 351)
...
TextLabel_32.Position = UDim2.new(1.0617907, 0, 0.192857146, 0)
TextLabel_32.Size = UDim2.new(0, 200, 0, 2)
...
TextLabel_33.Position = UDim2.new(1.3152585, 0, 0.19571428, 0)
TextLabel_33.Size = UDim2.new(0, -2, 0, 351)
...
TextLabel_34.Position = UDim2.new(1.05926859, 0, 0.698571444, 0)
TextLabel_34.Size = UDim2.new(0, 200, 0, -2)
...
TextLabel_35.Position = UDim2.new(0.0226986129, 0, 0.464285702, 0)
TextLabel_35.Size = UDim2.new(0, 357, 0, 274)
...
TextLabel_36.Position = UDim2.new(0.0226986129, 0, 0.38142857, 0)
TextLabel_36.Size = UDim2.new(0, 244, 0, 50)
TextLabel_36.Font = Enum.Font.SourceSansBold
TextLabel_36.Text = "Accuracy"
...
TextButton_9.Position = UDim2.new(0.0378310196, 0, 0.475714296, 0)
TextButton_9.Size = UDim2.new(0, 334, 0, 23)
TextButton_9.Font = Enum.Font.SourceSansBold
TextButton_9.Text = "Ctrl+ClickTP"
...
TextButton_10.Position = UDim2.new(0.0378310196, 0, 0.521428585, 0)
TextButton_10.Size = UDim2.new(0, 334, 0, 23)
TextButton_10.Font = Enum.Font.SourceSansBold
TextButton_10.Text = "GUI superJump"
...
TextButton_11.Position = UDim2.new(0.0378310196, 0, 0.5657143, 0)
TextButton_11.Size = UDim2.new(0, 334, 0, 26)
TextButton_11.Font = Enum.Font.SourceSansBold
TextButton_11.Text = "Rainbow Square"
...
TextButton_12.Position = UDim2.new(0.0378310196, 0, 0.617142856, 0)
TextButton_12.Size = UDim2.new(0, 334, 0, 25)
TextButton_12.Font = Enum.Font.SourceSansBold
TextButton_12.Text = "Rainbow circle"
...
TextLabel_37.Position = UDim2.new(0.51450187, 0, 0.38142857, 0)
TextLabel_37.Size = UDim2.new(0, 258, 0, 50)
TextLabel_37.Font = Enum.Font.SourceSansBold
TextLabel_37.Text = "Min. Damage"
...
TextLabel_39.Position = UDim2.new(0.0214375779, 0, 0.889999986, 0)
TextLabel_39.Size = UDim2.new(0, 200, 0, 50)
TextLabel_39.Font = Enum.Font.SourceSansBold
TextLabel_39.Text = "♥Save♥"
...
TextLabel_40.Position = UDim2.new(0.356872648, 0, 0.922857165, 0)
TextLabel_40.Size = UDim2.new(0, 200, 0, 50)
TextLabel_40.Font = Enum.Font.Unknown
TextLabel_40.Text = "By ASIDLANCHIK"
...
TextButton_13.Position = UDim2.new(0.533417404, 0, 0.475714296, 0)
TextButton_13.Size = UDim2.new(0, 330, 0, 23)
TextButton_13.Font = Enum.Font.SourceSansBold
TextButton_13.Text = "FLY (With Bugs)"
